...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private final String numberValidpattern ="^(13[0-9]|14[5|7]|15[0|1|2|3|5|6|7|8|9]|18[0|1|2|3|5|6|7|8|9])\\d{8}$";
    ...
    private void attemptLogin() {
        ...
        String number = mPhoneNumberView.getText().toString();
    ...
    private boolean isNumberValid(String phoneNumber) {
        ...
        boolean isMatch = Pattern.matches(numberValidpattern,phoneNumber);
        return isMatch;
    }
    ...
    public void onLoadFinished(Loader<Cursor> cursorLoader, Cursor cursor) {
        ...
        addNumbersToAutoComplete(emails);
    ...
    private void addNumbersToAutoComplete(List<String> numberCollection) {
        //Create adapter to tell the AutoCompleteTextView what to show in its dropdown list.
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(LoginActivity.this,
                        android.R.layout.simple_dropdown_item_1line, numberCollection);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                Intent it = new Intent(LoginActivity.this,AfterActivity.class);
                startActivity(it);
            } else {
